...
namespace RINOR_POS.Controllers
{
    ...
    {
        private ModelLicencePOSDB _db = new ModelLicencePOSDB();
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (Membership.ValidateUser(loginView.UserName, loginView.Password))
                    {
                        ...
                        if (user != null)
                        {
                            RINOR_POS.ModelLicence.CustomSerializeViewModel userModel = new RINOR_POS.ModelLicence.CustomSerializeViewModel()
                            {
