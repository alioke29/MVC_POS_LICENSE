...
{
    [Authorize]
    public class ccbankController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "CreditCardBank")] ccbankViewModel ccbankdata)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    pos_creditcard_bank.CreatedBy = UserProfile.employee_id;
                    pos_creditcard_bank.CreatedDate = DateTime.Now;
        ...
        public ActionResult Edit([Bind(Include = "CreditCardBankID, CreditCardBank")] ccbankViewModel ccbankdata)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    pos_creditcard_bank.CreditCardBank = ccbankdata.CreditCardBank;
                    pos_creditcard_bank.UpdatedBy = UserProfile.employee_id;
                    pos_creditcard_bank.UpdatedDate = DateTime.Now;
